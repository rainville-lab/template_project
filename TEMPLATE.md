...
<div style="border: 2px solid red; padding: 10px; color: red;">
    **Warning:** This file is meant to be deleted once you have populated your repository. It is only there to provide some guidance regarding what you should put where. The usage for each file/folder is described in the sections below.
</div>
